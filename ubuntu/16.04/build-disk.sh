...
DISK_FILE=${5:-"ubuntu-16.04-amd64-$RAM_SIZE-$DISK_SIZE.$DISK_FORMAT"}
OS="Ubuntu_16"
...
vboxmanage storageattach "$OS" --storagectl "IDE Controller" --port 0 --device 0 --type dvddrive --medium "$TMP_ISO_DIR"/ubuntu-16.04-netboot-amd64-unattended.iso
